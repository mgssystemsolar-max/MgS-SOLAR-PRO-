...
import { Sun, CheckCircle2, Zap, Calendar, TrendingUp, DollarSign, PenSquare, Clock, Info } from 'lucide-react';
...
export const ProposalView: React.FC<Props> = ({ 
  ...
  return (
    <div className="bg-white text-slate-800 p-8 rounded-xl shadow-2xl max-w-5xl mx-auto print:shadow-none print:p-0 print:max-w-none animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start border-b-4 border-green-500 pb-6 mb-8 gap-4">
        <div className="flex items-center gap-4 w-full md:w-auto">
            <img src="logo.png" alt="Logo" className="h-20 w-auto object-contain" onError={(e) => e.currentTarget.style.display='none'} />
      ...
      <div className="grid grid-cols-2 gap-12 mt-8 pt-8 border-t border-slate-300 print:break-inside-avoid">
        <div className="text-center">
            ...
            <div className="font-bold text-slate-700">{settings.companyName}</div>
